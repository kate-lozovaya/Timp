...
/*
	Реализация шаблонного класса очереди с приоритетами.

	Задача:
	Реализовать шаблонный класс очереди с приоритетами.

	Входные данные:
	<тип данных (double, int, char)>
	N - количество команд
	<команды работы с очередью из задания 5>
	...
	...
